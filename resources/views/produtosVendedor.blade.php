                    ...
                    <div class="modal" id="modal-editar-{{ $produto->idProduto }}">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('produtos.update', $produto->idProduto) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="text" name="nomeProduto" id="nome-{{ $produto->idProduto }}" value="{{$produto->nomeProduto}}">
                                <label for="valor">Valor</label>
                                <input type="text" name="valorProduto" id="valor-{{ $produto->idProduto }}" value="{{$produto->valorProduto}}">
                                <label for="descricao">Descrição</label>
                                <textarea id="descricao-{{ $produto->idProduto }}" name="descricaoProduto" value="Peça em bom estado, nunca usada">{{$produto->descricaoProduto}}</textarea>
                                <label for="cor">Cor</label>
                                <select id="cor" name="cor">
                                    <option value="">Selecione</option>
                                    @foreach($cores as $cor)
                                    <option value="{{ $cor->idCor }}" {{ $cor->idCor == $produto->idCor ? 'selected' : '' }}> {{ $cor->nomeCor }}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                <select id="regiao" name="regiao">
                                    ...
                                    <option value="{{ $regiao->idRegiao }}" {{ $regiao->idRegiao == $produto->idRegiao ? 'selected' : '' }}> {{ $regiao->nomeRegiao }}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                <select id="tamanho" name="tamanho">
                                    ...
                                    <option value="{{ $tamanho->idTamanho }}" {{ $tamanho->idTamanho == $produto->idTamanho ? 'selected' : '' }}> {{ $tamanho->nomeTamanho }}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                <select id="genero" name="roupa">
                                    ...
                                    <option value="{{ $genero->idGenero }}" {{ $genero->idGenero == $produto->idGenero ? 'selected' : '' }}> {{ $genero->nomeGenero }}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                <select id="categoria" name="categoria">
                                    ...
                                    <option value="{{ $categoria->idCategoriaProduto }}" {{ $categoria->idCategoriaProduto == $produto->idCategoriaProduto ? 'selected' : '' }}> {{ $categoria->nomeCategoriaProduto }}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                <select id="condicao" name="condicao">
                                    ...
                                    <option value="{{ $condicao->idCondicao }}" {{ $condicao->idCondicao == $produto->idCondicao ? 'selected' : '' }}> {{ $condicao->nomeCondicao }}
                                    </option>
                                    @endforeach
                                </select>
                                <div class="image-upload-section">
                                    <label for="image-upload-{{ $produto->idProduto }}" class="image-label">Editar Imagem
                                    </label>
                                    <input type="file" name="imagemProduto" id="image-upload-{{ $produto->idProduto }}" value="{{$produto->imagemProduto}}" class="image-input" accept="image/*">
