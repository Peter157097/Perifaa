                    ...
                    @foreach($produtos as $produto)
                        <div class="card-produto">
                            <div class="image-display">
                                <img class="img-card-produto" src="{{ asset($produto->imagemProduto) }}" alt="{{ $produto->nomeProduto }}">
                            </div>
                            ...
                            <div class="txt-info-produto">
                                <div class="row-info">
                                    <p>{{ $produto->cor->nomeCor ?? 'Cor Desconhecida' }}</p>
                                    <p>{{ $produto->condicao->nomeCondicao ?? 'Condição Desconhecida' }}</p>
                                </div>
                                <div class="row-info">
                                    <p>{{ $produto->categoria->nomeCategoriaProduto ?? 'Categoria Desconhecida' }}</p>
                                    <p>{{ $produto->tamanho->nomeTamanho ?? 'Tamanho Desconhecido' }}</p>
                                </div>
                                <div class="row-info">
                                   
                                    <p>{{ $produto->regiao->nomeRegiao ?? 'Região Desconhecida' }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
