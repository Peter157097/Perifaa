    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="slide1" src="{{url('images/carousel-image-one.png')}}" alt="Primerio Slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{url('images/carousel-image-two.png')}}" alt="Segundo Slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{url('images/carousel-image-one.png')}}" alt="Terceiro Slide">
            </div>
        </div>
    ...
    <main><!--Começo do corpo do site-->
        ...
        <div class="recomendados">
            ...
            <article class="cards-recomendados">
                ...
                <!--Card 3 começa aqui-->
                <div class="card-1">
                    <img class="image-card" src="{{url('images/teste.jpg')}}" alt="imagem paapa">
                    <div class="card-body">
                        <div class="card-top">
                            <div class="card-nome-brecho">
                                <i class="fa-solid fa-shop"></i>
        ...
        <div class="principais-brechos">
            ...
            <div class="cards-principais-brechos-tudo">
                <div class="cards-principais-brechos">
                    ...
                    <img src="{{('images/card-brecho-one-hover.png')}}" alt="Imagem ao passar o mouse" class="hover-image">
                </div>
                <div class="cards-principais-brechos">
                    <img src="{{('images/card-brecho-two.png')}}" alt="Segunda Imagem do brechó" class="original">
                    <img src="{{('images/card-brecho-two-hover.png')}}" alt="Imagem ao passar o mouse" class="hover-image">
                </div>
                <div class="cards-principais-brechos">
                    <img src="{{('images/card-brecho-three.png')}}" alt="Terceira Imagem do brechó" class="original">
                    <img src="{{('images/card-brecho-three-hover.png')}}" alt="Imagem ao passar o mouse" class="hover-image">
                </div>
            </div>
